                        ...
                        <div class="section">
                            ...
                            <div class="row px-2">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" onkeypress="onlyNumber(event)" value="{{ old('mobile') }}" name="mobile" class="form-control" placeholder="Phone number ..." pattern="^\d{10}$" title="Please enter exactly 10 digits." required>
                                    @error('mobile')
